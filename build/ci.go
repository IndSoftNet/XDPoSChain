...
func doArchive(cmdline []string) {
	...
	var (
		...
		XDC     = "XDC-" + base + ext
		alltools = "XDC-alltools-" + base + ext
	)
...
func doWindowsInstaller(cmdline []string) {
	...
	*workdir = makeWorkdir(*workdir)
	...
	installer, _ := filepath.Abs("XDC-" + archiveBasename(*arch, env) + ".exe")
...
func doAndroidArchive(cmdline []string) {
	...
	archive := "XDC-" + archiveBasename("android", env) + ".aar"
...
func doXCodeFramework(cmdline []string) {
	...
	archive := "XDC-" + archiveBasename("ios", env)
